...
describe('Accessibility Tests', () => {
  ...
  describe('CalendarHeader Accessibility', () => {
    ...
    it('should have proper button labels', () => {
      ...
      expect(
        screen.getByLabelText('Navigasi ke minggu sebelumnya'),
      ).toBeInTheDocument()
      expect(
        screen.getByLabelText('Navigasi ke minggu selanjutnya'),
      ).toBeInTheDocument()
      expect(
        screen.getByLabelText('Muat ulang data kalender'),
      ).toBeInTheDocument()
      expect(
        screen.getByLabelText('Masuk ke mode layar penuh'),
      ).toBeInTheDocument()
    })
    ...
    it('should update fullscreen button label when in fullscreen', () => {
      ...
      expect(
        screen.getByLabelText('Keluar dari mode layar penuh'),
      ).toBeInTheDocument()
    })
    ...
    it('should update refresh button label when refreshing', () => {
      ...
      expect(
        screen.getByLabelText('Sedang memuat ulang data'),
      ).toBeInTheDocument()
    })
  })
